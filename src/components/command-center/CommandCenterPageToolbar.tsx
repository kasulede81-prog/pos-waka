...
export function CommandCenterPageToolbar({
  ...
  return (
    <div className="space-y-3">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className={clsx(
              ...
              searchOpen ? "border-waka-300 bg-waka-50 text-waka-700" : "border-stone-200 bg-white text-stone-700",
            )}
      ...
      <p className="text-xs font-bold text-stone-600">{shopName}</p>
      ...
      {searchOpen ? (
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-stone-200 bg-white py-2.5 pl-10 pr-3 text-sm font-medium text-stone-900 shadow-sm outline-none ring-waka-500/30 focus:ring-2"
          />
        </div>
      ) : null}
    </div>
