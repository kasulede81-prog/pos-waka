  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div
        role="dialog"
        aria-modal="true"
        className="w-full max-w-md overflow-hidden rounded-lg border-2 border-stone-300 bg-stone-100 shadow-2xl"
      >
        <div className="border-b border-stone-300 bg-white px-5 py-4 text-center">
          <h2 className="text-lg font-black uppercase tracking-wide text-stone-800">{t(lang, "openTableTitle")}</h2>
          <p className="mt-2 text-2xl font-black text-stone-950">{tableLabel}</p>
        ...
        <div className="grid grid-cols-2 gap-0 border-t border-stone-300">
          <button
            type="button"
            onClick={onCancel}
            className="min-h-14 border-r border-stone-300 bg-stone-200 text-sm font-black uppercase text-stone-700"
          >
            {t(lang, "cancel")}
          </button>
          <button
            ...
            className="min-h-14 bg-emerald-600 text-sm font-black uppercase text-white disabled:opacity-60"
          >
