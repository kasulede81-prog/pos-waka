  ...
  return (
    <div className="mt-3 rounded-2xl border border-emerald-200 bg-emerald-50/70 p-3 text-sm">
      ...
      <dl className="mt-2 space-y-1.5">
        ...
        <div className="flex justify-between gap-2">
          <dt className="font-semibold text-muted-foreground">{t(lang, "returnSummaryRefunding")}</dt>
        ...
        <div className="flex justify-between gap-2 border-t border-emerald-100 pt-1.5">
          <dt className="font-semibold text-muted-foreground">{t(lang, "returnSummaryRemainingAfter")}</dt>
          <dd className="font-bold text-foreground">UGX {Math.max(0, remainingAfterUgx).toLocaleString()}</dd>
        </div>
      </dl>
      {customRefund ? (
