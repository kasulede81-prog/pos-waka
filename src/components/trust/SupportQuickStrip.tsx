...
export function SupportQuickStrip({ lang }: Props) {
  return (
    <details className="group rounded-2xl border border-waka-200/90 bg-gradient-to-br from-waka-50 to-white shadow-sm">
      ...
      <div className="border-t border-waka-100/90 px-4 pb-4 pt-3">
        ...
        <div className="mt-3 grid gap-2 sm:grid-cols-2">
          ...
          <Link
            to="/support"
            className="inline-flex min-h-[48px] items-center justify-center rounded-2xl border-2 border-waka-200 bg-white px-4 text-sm font-black text-waka-950"
          >
