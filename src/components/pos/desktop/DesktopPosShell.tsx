...
export function DesktopPosShell({
  ...
  return (
    <div
      className={clsx("desktop-pos-terminal flex min-h-0 flex-1 flex-col overflow-hidden bg-background", className)}
      data-desktop-pos-terminal
    >
      {header}

      <div className="desktop-pos-terminal__body grid min-h-0 flex-1 overflow-hidden">
        <aside className="desktop-pos-terminal__rail flex min-h-0 flex-col border-r border-border bg-card">
        ...
        <main className="desktop-pos-terminal__catalog relative flex min-h-0 min-w-0 flex-col overflow-hidden">
          <div className="shrink-0 border-b border-border bg-card px-3 py-2.5">{searchBar}</div>
          <div className="relative min-h-0 flex-1 overflow-hidden">
            <div className="desktop-pos-terminal__catalog-scroll h-full min-h-0 overflow-y-auto overscroll-y-contain p-3">
              {catalog}
            </div>
            {catalogCheckoutDock}
          </div>
        ...
        <aside className="desktop-pos-terminal__cart min-h-0 min-w-0 border-l border-border bg-card">
          {cart}
        </aside>
      </div>
