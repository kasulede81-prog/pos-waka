...
export function FloatVerifyOverrideModal({
  ...
  return (
    ...
    >
      <p className="text-sm font-medium text-stone-600">{t(lang, "shiftFloatOverrideBody")}</p>
      ...
      <div className="mt-4 space-y-2">
        {(
          ...
          <label key={value} className="flex min-h-[44px] cursor-pointer items-center gap-2 rounded-xl border border-stone-200 px-3 py-2">
            <input
              type="radio"
