  ...
  return (
    <>
      ...
      <div className={compact ? "mt-2" : "mt-4"}>
        ...
        <div className={clsx("mt-1.5 grid gap-1.5", compact ? "grid-cols-4" : "grid-cols-2 gap-2 mt-2")}>
          {checkoutMethods.map((method) => (
            <button
              ...
              className={clsx(
                ...
                compact ? "min-h-[36px] px-1 text-[11px]" : "min-h-[48px] rounded-2xl text-sm",
      ...
      {(paymentMethod === "cash" || paymentMethod === "credit") && (cashInput || changeDue > 0) ? (
        <p
          className={clsx(
            ...
            compact ? "mt-1.5 rounded-lg bg-emerald-50 px-3 py-1.5 text-sm" : "mt-3 rounded-xl bg-emerald-50 px-4 py-3 text-base",
          )}
        >
    ...
    >
      ...
      {emptyCart ? (
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          ...
          <div className="shrink-0 border-t border-waka-200 bg-white px-3 py-2 shadow-[0_-6px_16px_rgba(0,0,0,0.06)]">
      ...
      <footer
        className={clsx(
          ...
          isCompact ? "px-3 py-2 pb-[max(0.5rem,env(safe-area-inset-bottom,0px))]" : "px-4 py-3",
