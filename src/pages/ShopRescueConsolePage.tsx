  ...
  return (
    <AdminShell lang={lang} adminRow={shellAdmin} loading={false} active="shop" previewMode={previewMode}>
      <div className="space-y-4">
        <header className="rounded-2xl border border-orange-200 bg-gradient-to-br from-orange-50 to-white p-4 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="text-[10px] font-black uppercase tracking-widest text-orange-800">Shop Rescue Console</p>
