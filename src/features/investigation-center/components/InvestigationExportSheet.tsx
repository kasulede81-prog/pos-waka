        ...
        {items.map((item) => (
          <li key={item.label}>
            <button
              ...
              className="flex min-h-[52px] w-full items-center gap-3 rounded-2xl px-2 text-left text-sm font-bold text-stone-800 active:bg-stone-50 disabled:opacity-40"
            >
