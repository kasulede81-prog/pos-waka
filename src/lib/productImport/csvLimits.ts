...
export const CSV_IMPORT_NO_PACK_TEMPLATE_FILENAME = "WAKA Product Import — No Packs.csv";
export const CSV_IMPORT_WITH_PACK_TEMPLATE_FILENAME = "WAKA Product Import — With Packs.csv";
