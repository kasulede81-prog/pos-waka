...
describe("ASK-INTEL-2 code intelligence", () => {
  ...
  it("T17: live POS tool names unchanged (plus ASK-SHIFT-REPORT-IMPLEMENT-01 and ASK-2 intelligence layer additions)", () => {
    expect(ASK_WAKA_TOOL_NAMES).toHaveLength(17);
  });
