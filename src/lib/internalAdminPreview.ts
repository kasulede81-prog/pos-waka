...
export const PREVIEW_FLEET_DEVICES: FleetDeviceRow[] = [
  {
    id: "preview-dev-1",
    shop_id: PREVIEW_SHOP_ID,
    device_fingerprint: "fp-preview-1",
...
export const PREVIEW_SHOP_OPS_DETAIL: ShopOpsDetail = {
  shop: {
    ...
    city: "Central",
    area: "Nakasero",
    address_line: "Plot 12 Sample Rd",
