...
export const STORE_ACTION_PERMISSIONS = {
  ...
  advanceKitchenTicket: "hospitality.kitchen",
  recallKitchenTicket: "hospitality.kitchen",
  cancelKitchenTicket: "hospitality.kitchen",
  cancelKitchenTicketItem: "hospitality.kitchen",
  cleanupKitchenTickets: "hospitality.kitchen",
  fireTableKitchenTickets: "hospitality.order",
  ...
  addKitchenStation: "hospitality.floor",
  updateKitchenStation: "hospitality.floor",
  removeKitchenStation: "hospitality.floor",
  createTableReservation: "hospitality.floor",
  updateTableReservation: "hospitality.floor",
  cancelTableReservation: "hospitality.floor",
  markReservationNoShow: "hospitality.floor",
  addWaitlistEntry: "hospitality.floor",
  cancelWaitlistEntry: "hospitality.floor",
  combineTables: "hospitality.floor",
  splitCombinedTables: "hospitality.floor",
  lockTable: "hospitality.floor",
  unlockTable: "hospitality.floor",
  startTableCleaning: "hospitality.floor",
  finishTableCleaning: "hospitality.floor",
  upsertWaiterSection: "hospitality.floor",
