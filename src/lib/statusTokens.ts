 ...
 *
 * Phase 29.1: badges/banners use saturated `text-{kind}` on `bg-{kind}-muted`
 * (not `text-{kind}-foreground`, which is reserved for solid fills).
 */
...
/**
 * Explicit class strings (no runtime template expansion) so Tailwind JIT
 * always emits the utilities. On-muted text uses saturated `text-{kind}`;
 * solid fills keep `*-foreground` (white/inverse) elsewhere.
 */
export const statusTokens: Record<StatusKind, StatusClasses> = {
  success: {
    badge: `${BASE_BADGE} bg-success-muted text-success ring-success/30`,
    badgeRing: `${BASE_BADGE} bg-success-muted text-success ring-success/40`,
    dot: `${BASE_DOT} bg-success`,
    icon: `${BASE_ICON} bg-success-muted text-success`,
    banner: `${BASE_BANNER} border-success/30 bg-success-muted text-success`,
  },
  warning: {
  ...
  danger: {
    badge: `${BASE_BADGE} bg-danger-muted text-danger ring-danger/30`,
    badgeRing: `${BASE_BADGE} bg-danger-muted text-danger ring-danger/40`,
    dot: `${BASE_DOT} bg-danger`,
    icon: `${BASE_ICON} bg-danger-muted text-danger`,
    banner: `${BASE_BANNER} border-danger/30 bg-danger-muted text-danger`,
  },
  info: {
    badge: `${BASE_BADGE} bg-info-muted text-info ring-info/30`,
    badgeRing: `${BASE_BADGE} bg-info-muted text-info ring-info/40`,
    dot: `${BASE_DOT} bg-info`,
    icon: `${BASE_ICON} bg-info-muted text-info`,
    banner: `${BASE_BANNER} border-info/30 bg-info-muted text-info`,
  },
  draft: {
    badge: `${BASE_BADGE} bg-draft-muted text-draft ring-draft/30`,
    badgeRing: `${BASE_BADGE} bg-draft-muted text-draft ring-draft/40`,
    dot: `${BASE_DOT} bg-draft`,
    icon: `${BASE_ICON} bg-draft-muted text-draft`,
    banner: `${BASE_BANNER} border-draft/30 bg-draft-muted text-draft`,
  },
  pending: {
  ...
  trial: {
    badge: `${BASE_BADGE} bg-trial-muted text-trial ring-trial/30`,
    badgeRing: `${BASE_BADGE} bg-trial-muted text-trial ring-trial/40`,
    dot: `${BASE_DOT} bg-trial`,
    icon: `${BASE_ICON} bg-trial-muted text-trial`,
    banner: `${BASE_BANNER} border-trial/30 bg-trial-muted text-trial`,
  },
  expired: {
    badge: `${BASE_BADGE} bg-expired-muted text-expired ring-expired/30`,
    badgeRing: `${BASE_BADGE} bg-expired-muted text-expired ring-expired/40`,
    dot: `${BASE_DOT} bg-expired`,
    icon: `${BASE_ICON} bg-expired-muted text-expired`,
    banner: `${BASE_BANNER} border-expired/30 bg-expired-muted text-expired`,
  },
  cancelled: {
    badge: `${BASE_BADGE} bg-cancelled-muted text-cancelled ring-cancelled/30`,
    badgeRing: `${BASE_BADGE} bg-cancelled-muted text-cancelled ring-cancelled/40`,
    dot: `${BASE_DOT} bg-cancelled`,
    icon: `${BASE_ICON} bg-cancelled-muted text-cancelled`,
    banner: `${BASE_BANNER} border-cancelled/30 bg-cancelled-muted text-cancelled`,
  },
  offline: {
    badge: `${BASE_BADGE} bg-offline-muted text-offline ring-offline/30`,
    badgeRing: `${BASE_BADGE} bg-offline-muted text-offline ring-offline/40`,
    dot: `${BASE_DOT} bg-offline`,
    icon: `${BASE_ICON} bg-offline-muted text-offline`,
    banner: `${BASE_BANNER} border-offline/30 bg-offline-muted text-offline`,
  },
  syncing: {
    badge: `${BASE_BADGE} bg-syncing-muted text-syncing ring-syncing/30`,
    badgeRing: `${BASE_BADGE} bg-syncing-muted text-syncing ring-syncing/40`,
    dot: `${BASE_DOT} bg-syncing`,
    icon: `${BASE_ICON} bg-syncing-muted text-syncing`,
    banner: `${BASE_BANNER} border-syncing/30 bg-syncing-muted text-syncing`,
  },
  paid: {
    badge: `${BASE_BADGE} bg-paid-muted text-paid ring-paid/30`,
    badgeRing: `${BASE_BADGE} bg-paid-muted text-paid ring-paid/40`,
    dot: `${BASE_DOT} bg-paid`,
    icon: `${BASE_ICON} bg-paid-muted text-paid`,
    banner: `${BASE_BANNER} border-paid/30 bg-paid-muted text-paid`,
  },
  free: {
    badge: `${BASE_BADGE} bg-free-muted text-free ring-free/30`,
    badgeRing: `${BASE_BADGE} bg-free-muted text-free ring-free/40`,
    dot: `${BASE_DOT} bg-free`,
    icon: `${BASE_ICON} bg-free-muted text-free`,
    banner: `${BASE_BANNER} border-free/30 bg-free-muted text-free`,
  },
  business: {
    badge: `${BASE_BADGE} bg-business-muted text-business ring-business/30`,
    badgeRing: `${BASE_BADGE} bg-business-muted text-business ring-business/40`,
    dot: `${BASE_DOT} bg-business`,
    icon: `${BASE_ICON} bg-business-muted text-business`,
    banner: `${BASE_BANNER} border-business/30 bg-business-muted text-business`,
  },
  vip: {
    badge: `${BASE_BADGE} bg-vip-muted text-vip ring-vip/30`,
    badgeRing: `${BASE_BADGE} bg-vip-muted text-vip ring-vip/40`,
    dot: `${BASE_DOT} bg-vip`,
    icon: `${BASE_ICON} bg-vip-muted text-vip`,
    banner: `${BASE_BANNER} border-vip/30 bg-vip-muted text-vip`,
  },
  active: {
    badge: `${BASE_BADGE} bg-active-muted text-active ring-active/30`,
    badgeRing: `${BASE_BADGE} bg-active-muted text-active ring-active/40`,
    dot: `${BASE_DOT} bg-active`,
    icon: `${BASE_ICON} bg-active-muted text-active`,
    banner: `${BASE_BANNER} border-active/30 bg-active-muted text-active`,
  },
...
export function errorStateClasses(): { shell: string; icon: string; title: string; body: string } {
  return {
    ...
    title: "mt-4 text-lg font-black text-danger",
    body: "mt-2 text-sm font-medium text-danger/90",
  };
}
