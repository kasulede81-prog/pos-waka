-- SL-03: already-completed shop_push_sale_complete is a mutation-free ACK.
-- Stale device payloads must not replace completed lines, payments, or financials,
-- and must not call apply_sale_stock_movements again.
