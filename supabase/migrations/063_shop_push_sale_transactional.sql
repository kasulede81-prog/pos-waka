-- Transactional sale push: single RPC replaces multi-step client sale sync.
...
begin
  ...
  -- Align product stock to pre-sale levels before completing (client stock already decremented locally).
